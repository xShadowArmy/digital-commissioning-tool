...
public class TreeViewItem
{
    ...
    public class HoverOnEventArgs : System.EventArgs
    {
    }
    public EventHandler HoverOn = null;
    public class HoverOffEventArgs : System.EventArgs
    {
    }
    ...
    public void DisplayItem(int levels, SiblingOrder siblingOrder)
    {
        ...
        if (!string.IsNullOrEmpty(Header))
        {
            ...
            {
                //use selected skin
                GUI.skin = ParentControl.m_skinDefault;
                isSelected = true;
            }
            else
            {
        ...
        if (ParentControl.IsHoverEnabled)
        {
                ...
                Event.current.type == EventType.Repaint)
            {
                ...
                if (ParentControl.HasFocus(mousePos))
                {
                    ...
                    {
                        if (null != HoverOff && IsHover)
                        {
                            HoverOff.Invoke(this, new HoverOffEventArgs());
                        }
                        IsHover = false;
                    }
                    if (ParentControl.IsHoverEnabled &&
