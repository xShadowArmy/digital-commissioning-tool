...
public class TreeViewControl : MonoBehaviour
{
    ...
    /// </summary>
    public GUISkin m_skinDefault = null;
    ...
    {
        var temp = m_skinUnselected.button.normal.background;
        m_skinUnselected.button.normal.background = texture;
        GUI.skin = m_skinUnselected;
        bool success = GUILayout.Button(texture, GUILayout.MaxWidth(texture.width), GUILayout.MaxHeight(texture.height));
        m_skinUnselected.button.normal.background = temp;
        return success;
    }
    ...
    public bool Button(TreeViewItem.TextureIcons item)
    {
        switch (item)
        {
            ...
            case TreeViewItem.TextureIcons.LAST_SIBLING_NO_CHILD:
                ...
                {
                    return ShowButtonTexture(m_textureLastSiblingNoChild);
                }
			...
			case TreeViewItem.TextureIcons.NORMAL_CHECKED:
                ...
                {
                    return ShowButtonTexture(m_textureNormalChecked);
                }
